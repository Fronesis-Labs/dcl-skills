...
description: Crypto-specific hallucination/drift detector: catches agent claims about token economics, contract behavior, or prices that drift from verified on-chain/ground-truth sources. Use this skill whenever the user's request touches this specific check, even if not explicitly named.
---
...
Crypto-specific hallucination/drift detector: catches agent claims about token economics, contract behavior, or prices that drift from verified on-chain/ground-truth sources.
