...
description: Tracks and verifies the provenance of on-chain data / contract source referenced by the agent, flagging unverified or spoofed sources. Use this skill whenever the user's request touches this specific check, even if not explicitly named.
---
...
Tracks and verifies the provenance of on-chain data / contract source referenced by the agent, flagging unverified or spoofed sources.
