...
description: Sanitizes agent-generated output (e.g. transaction summaries, chat replies) to strip embedded addresses/keys/injection payloads before display or execution. Use this skill whenever the user's request touches this specific check, even if not explicitly named.
---
...
Sanitizes agent-generated output (e.g. transaction summaries, chat replies) to strip embedded addresses/keys/injection payloads before display or execution.
