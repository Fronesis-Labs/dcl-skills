...
description: Verifies trade/swap parameters (slippage, route, counterparty contract) against expected bounds before execution to catch manipulated or malicious trade instructions. Use this skill whenever the user's request touches this specific check, even if not explicitly named.
---
...
Verifies trade/swap parameters (slippage, route, counterparty contract) against expected bounds before execution to catch manipulated or malicious trade instructions.
