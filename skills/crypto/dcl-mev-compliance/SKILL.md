...
description: Checks agent-initiated transactions for MEV-exposure risk and compliance constraints (sandwich risk, front-running exposure) before broadcast. Use this skill whenever the user's request touches this specific check, even if not explicitly named.
---
...
Checks agent-initiated transactions for MEV-exposure risk and compliance constraints (sandwich risk, front-running exposure) before broadcast.
