...
description: Prompt-injection firewall specialized for DeFi/crypto contexts: malicious contract text, fake airdrop prompts, wallet-drainer instructions embedded in on-chain data or dApp content. Use this skill whenever the user's request touches this specific check, even if not explicitly named.
---
...
Prompt-injection firewall specialized for DeFi/crypto contexts: malicious contract text, fake airdrop prompts, wallet-drainer instructions embedded in on-chain data or dApp content.
