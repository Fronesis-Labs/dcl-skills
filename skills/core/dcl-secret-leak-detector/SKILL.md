...
description: Scans agent inputs/outputs for leaked secrets (API keys, private keys, credentials) and redacts or blocks them. Use this skill whenever the user's request touches this specific check, even if not explicitly named.
---
...
Scans agent inputs/outputs for leaked secrets (API keys, private keys, credentials) and redacts or blocks them.
